...
class IntegratedModel(nn.Module):
    def __init__(self, age=True, gender=True):
        super(IntegratedModel, self).__init__()
        self.encoder = MobileNetV3(classify=True, n_class=8631, mode='small')
        self.encoder.classify = False
        self.age = SimpleClassifier(512, 120) if age else None
        self.gender = SimpleClassifier(512, 2) if gender else None
...
class SimpleClassifier(nn.Module):
    def __init__(self, input_size, num_of_classes):
        ...
        self.fc = nn.Linear(input_size, num_of_classes)
...
class MobileNetV3(nn.Module):
    def __init__(self, classify=False, n_class=None, input_size=224, dropout=0.2, mode='small',
                 width_mult=1.0):
